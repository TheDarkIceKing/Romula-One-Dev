...
module.exports.run = async(bot, message, args) => {
    ...
    for (var team in teamlist.teams) {
        ...
        allteams.push(embed.fields)
        
        
    }
    message.channel.send({content: JSON.stringify(allteams)})
}
